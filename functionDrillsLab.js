...
let nameGreeting = nameCheck("Gino")
...
bestMovie = strMovie => `${strMovie} is the best movie ever!`
...
theEliminator = (contestants1, loser1 ) => {
...
stringOutPut = str => console.log(str.toUpperCase())
stringOutPut(sampleString)
...
emailCheck = email =>  {
  let emailResult = String(email.trim())
...
console.log(emailCheck("ginotasis@gmail.com"))
...
buyChocolateFrogs = goldToSpend => {
  let chocolateFrog = 3
  if (goldToSpend / chocolateFrog >= 1) {
    return `You can buy ${goldToSpend / chocolateFrog} frog(s)`
  } else if (goldToSpend / chocolateFrog < chocolateFrog) {
